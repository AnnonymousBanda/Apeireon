...
const scrollObserver = new IntersectionObserver(
	(entries) => {
		...
		if (!entry.isIntersecting) {
			...
			document
				.querySelector('#home nav [href="#events"]')
				.classList.add('selected')
			document
				.querySelector('#home nav [href="#home"]')
...
document.querySelector('.links').addEventListener('click', (event) => {
	if (
		...
		event.target.textContent === 'EVENTS' ||
		event.target.textContent === 'HACKMATRIX'
	) {
...
////////////////////
//modal for posters
document.querySelector('#events .container').addEventListener('click',(e)=>{
